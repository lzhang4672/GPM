...
def run_one(dataset_key: str, seeds: int, gpu: int, epochs: int, data_path: str | None, pattern_path: str | None):
    cmd = [
        sys.executable,
        "GPM/main.py",
        "--dataset",
    ...
    if pattern_path:
        cmd.extend(["--pattern_path", pattern_path])
...
def main():
    ...
    for display_name, dataset_key in DEFAULT_DATASETS:
        ...
        metrics = run_one(dataset_key, args.seeds, args.gpu, args.epochs, args.data_path, args.pattern_path)
